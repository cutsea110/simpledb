...
impl fmt::Display for SetU16Record {
...
impl LogRecord for SetU16Record {
    fn op(&self) -> TxType {
        TxType::SETU16
    }
    ...
    fn undo(&mut self, tx: Arc<Mutex<Transaction>>) -> Result<()> {
        ...
        tx.lock()
            .unwrap()
            .set_u16(&self.blk, self.offset, self.val, false)?; // don't log the undo!
...
impl SetU16Record {
    ...
    pub fn write_to_log(
        ...
        p.set_i32(0, TxType::SETU16 as i32)?;
